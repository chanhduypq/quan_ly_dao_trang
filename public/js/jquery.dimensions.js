...
$.fn.extend({
	...
	height: function() {
		...
		if ( this[0] == window )
//                    tuetc
			if (false)// ($.browser.mozilla || $.browser.opera) && $(document).width() > self.innerWidth)
	...
	width: function() {
		...
		if ( this[0] == window )
//                    tuetc
			if (false) //($.browser.mozilla || $.browser.opera) && $(document).height() > self.innerHeight)
				// mozilla and opera both return width + scrollbar width
	...
	offset: function(options, returnObject) {
		...
		var x = 0, y = 0, sl = 0, st = 0,
		    elem = this[0], parent = this[0], op, parPos, elemPos = $.css(elem, 'position'),
                    mo = false, ie = false, sf = false, oa = false,
//                    tuetc
...
var handleOffsetReturn = function(elem, options, x, y, sl, st) {
	...
	if ( options.border && ($.browser.safari || $.browser.opera) ) {
		x += num(elem, 'borderLeftWidth');
		y += num(elem, 'borderTopWidth');
        } else if ( !options.border && !(false || false) ) {        
//                tuetc
//	} else if ( !options.border && !($.browser.safari || $.browser.opera) ) {
	...
	// do not include scroll offset on the element ... opera sometimes reports scroll offset as actual offset
        if ( options.scroll && (false && elem.offsetLeft != elem.scrollLeft && elem.offsetTop != elem.scrollLeft) ) { 
//        tuetc
